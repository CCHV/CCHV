...
\begin{figure}
  ...
  %\subfloat[\label{fig:fig_Results_Estimation_Camera_Profil_highStat_CC_simulation_Hadronth_LineCone}]{\includegraphics[width=0.48\textwidth]{./Figure/profile_high_stat_linecone_2.pdf}}
	\subfloat[\label{fig:fig_Results_Estimation_Camera_Profil_highStat_CC_simulation_Hadronth_LineCone}]{\includegraphics[width=0.48\textwidth]{./Figure/reference_profile_highStat_smooth.pdf}}
 % \subfloat[\label{fig:fig_Results_Estimation_Camera_Profil_highStat_CC_simulation_Hadronth_MLEM}]{\includegraphics[width=0.48\textwidth]{./Figure/profileY_corr_r15.png}}\\
   \subfloat[\label{fig:fig_Results_Estimation_Camera_Profil_highStat_CC_simulation_Hadronth_MLEM}]{\includegraphics[width=0.48\textwidth]{./Figure/new/reconstructed_histStat_profile.pdf}}\\
...
\subfloat[]{\includegraphics[width=0.5\textwidth]{./Figure/new/reconstructed_lowStat_profile.pdf}}\\
...
\subfloat[]{\includegraphics[width=0.5\textwidth]{./Figure/profile_line_cone_lowStat.pdf}}
