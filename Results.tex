...
\begin{figure}
  ...
  \caption{Distributions of the falloff position deviation with respect to the falloff position of the high statistics reference profile for 1000 10$^8$ primary protons profiles realizations. The RMS of these distributions represents the Compton camera precision for the selected statistics.}\end{figure}
...
\subfloat[]{\includegraphics[width=0.5\textwidth]{./Figure/new/reconstructed_lowStat_profile_norm.pdf}}\\
...
\subfloat[]{\includegraphics[width=0.5\textwidth]{./Figure/new/recon_profile_line-cone_lowStat_norm.pdf}}
