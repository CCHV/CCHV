...
\begin{figure}
\centering
\subfloat[]{\includegraphics[width=0.5\textwidth,clip=true,trim=0 70 130 90]{./Figure/new/recon_200pBunch/projection2D_Z_corr_r20.png}}
\subfloat[]{\includegraphics[width=0.5\textwidth]{./Figure/new/profile_lineCone_200pBunch.pdf}}\\
%\subfloat[]{\includegraphics[width=0.5\textwidth]{./Figure/profileY_corr_r20.png}}\\
\subfloat[]{\includegraphics[width=0.5\textwidth]{./Figure/new/profile_MLEM_200pBunch.pdf}}
...
%\subfloat[]{\includegraphics[width=0.5\textwidth]{./Figure/profileY_corr_r20.png}}\\
\subfloat[]{\includegraphics[width=0.5\textwidth]{./Figure/new/reconstructed_lowStat_profile_norm_mod.png}}
%\subfloat[]{\includegraphics[width=0.5\textwidth]{./Figure/2015_02_16_Reconstruction_coinc_160MeVProton_TOF_6ns_file0to100_zoom.pdf}}
