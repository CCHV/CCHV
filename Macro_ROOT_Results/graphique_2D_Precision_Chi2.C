...
//Double_t number_datas = 19;
   ...
   //
	...
	char name[80];	sprintf(name, "Precision vs number of incident protons"); // Nom du graphique
	
	
	
	TH1 *frame = new TH1F("frame","",1000,1e8,1e10);
	...
	frame->GetYaxis()->SetTitle("Precision [mm]");
